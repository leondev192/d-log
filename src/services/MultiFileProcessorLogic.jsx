...
// Sử dụng đường dẫn worker từ `pdfjs-dist/build/pdf.worker.entry`
pdfjsLib.GlobalWorkerOptions.workerSrc =
  "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.16.105/pdf.worker.min.js";

// Constants
const GOOGLE_VISION_API_KEY = import.meta.env.VITE_GOOGLE_VISION_API_KEY;
const GEMINI_API_KEY = "AIzaSyDZmYOaYBq4eMaXerVh7kDjgpB5nsm_8bc";
...
9. Place of Delivery (no accents): …(example  HO CHI MINH, VIETNAM CFS)
...
14. Gross Weight (extract only the number): …(example 1899.58)
...
export const parseAIResponse = (response) => {
  ...
  const patterns = {
    "M-Bill of Lading No": /M-Bill of Lading No.: (.+)/,
    "H-Bill of Lading No": /H-Bill of Lading No.: (.+)/,
  ...
  for (const [key, regex] of Object.entries(patterns)) {
    ...
    if (match) {
      data[key] = match[1].trim(); // Only store matched results
    }
  }

  return data; // Only show extracted results
};
...
// // Constants
// const GOOGLE_VISION_API_KEY = import.meta.env.VITE_GOOGLE_VISION_API_KEY;
// const COHERE_API_KEY = "WGWCcIWA0VxZNsGhHipgZcZ9RzZqHEHzL28Pa6Zs";
...
// export const sendToCohere = async (combinedText) => {
//   const prompt = createPrompt(combinedText);
...
//     console.log("Raw API Response:", response.data); // Log toàn bộ phản hồi từ API
...
//       console.log("Parsed AI Text:", aiText); // Log phản hồi đã cắt gọn

//       // Kiểm tra nếu phản hồi là JSON hợp lệ
//       try {
//         const jsonData = JSON.parse(aiText);
//         console.log("Parsed JSON Data:", jsonData); // Log JSON đã parse
//         return jsonData;
//       } catch (parseError) {
//         console.warn("Response is not valid JSON. Returning raw text.");
//         return aiText; // Trả về chuỗi thô nếu không phải JSON
//       }
//     }
...
// export const createPrompt = (text) => `
// Extract the following information from the provided text and format the response as a structured JSON object with key-value pairs. Only include the requested fields and omit unnecessary information like telephone, fax numbers, or email unless explicitly required. Follow the examples provided:

// {
//   "M-Bill of Lading No.": "PLN00203022",
//   "H-Bill of Lading No.": "HCMBKK029112022",
//   "Description of Goods": "FABRIC 100 PCT. POLYESTER W: 114 CM",
//   "Consignor/Shipper": "MAC NELS SHIPPING VIETNAM CO., LTD, 29 PHO DỌC CHINH STR, DIST 1, HOCHIMINH CITY, VIETNAM",
//   "Consignee/Consigned to Order of": "TO THE ORDER OF THE HOLDER SURRENDERED BBL NO. 1/DKK 290439 TO BE ISSUED BY MAC - NELS CONTAINER LINES",
//   "Notify Party": "PRO LOG CO., LTD, 191/14 CTL TOWEL, 28TH FLOOR, RATCHADAPISE RD., KLONG TOEY BANGKOK 10110 THAILAND",
//   "Port of Loading": "VNCLI",
//   "Port of Discharge": "THBKK",
//   "Place of Delivery": "HO CHI MINH, VIETNAM CFS",
//   "Number of Packages": 1,
//   "Kind of Packages": "CT",
//   "Container No.": "CSLU2082865",
//   "Seal No.": "21567932",
//   "Gross Weight": 1899.58,
//   "CBM/Volume": 1.000,
//   "Place and Date of Issue": "01/12/2022"
// }

// Use the following codes to replace values where applicable:
// 1. **Ports of Loading/Discharge**:
//    - YOKOHAMA => JPYOK
...
// Please ensure the response strictly adheres to the JSON format specified above.
...
//       return jsonData;
//     } catch (parseError) {
//       console.warn("Response is not a valid JSON string.");
//       return { rawResponse: response }; // Trả về dạng thô nếu không phải JSON
//     }
//   }

//   if (typeof response === "object") {
//     console.log("Response is already parsed JSON:", response);
//     return response; // Trả về trực tiếp nếu là JSON
//   }
